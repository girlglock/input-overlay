...
if sys.platform == "win32":
    ...
    MOUSE_BUTTON_MAP = {
        ...
        **({mouse.Button.x1: 4} if hasattr(mouse.Button, 'x1') else {}),
...
_EVDEV_TO_HID: dict[int, int] = {
    ...
    82:  0x62,  #KEY_KP0
    83:  0x63,  #KEY_KPDOT
    85:  0x64,  #KEY_ZENKAKUHANKAKU
    86:  0x64,  #KEY_102ND (ISO backslash)
    87:  0x44,  #KEY_F11
    88:  0x45,  #KEY_F12
    96:  0x58,  #KEY_KPENTER
    97:  0xE4,  #KEY_RIGHTCTRL
    98:  0x54,  #KEY_KPSLASH
    99:  0x46,  #KEY_SYSRQ (print)
    ...
    110: 0x49,  #KEY_INSERT
    111: 0x4C,  #KEY_DELETE
    125: 0xE3,  #KEY_LEFTMETA (win)
    126: 0xE7,  #KEY_RIGHTMETA (rwin)
